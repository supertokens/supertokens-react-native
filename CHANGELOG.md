...
- Moves to using native `URL` library instead of polyfilling with `react-native-url-polyfill` since the functions of URL that are being used are present in the native implementation now.
