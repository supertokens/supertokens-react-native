 ...
 */
export function handleUnauthorised(preRequestIdToken, httpCall) {
    return __awaiter(this, void 0, void 0, function*() {
        let result = yield onUnauthorisedResponse(preRequestIdToken, httpCall);
            ...
            while (true) {
                ...
                try {
                    ...
                    if (response.status === AuthHttpRequest.config.sessionExpiredStatusCode) {
                        let retry = yield handleUnauthorised(preRequestIdToken);
                        if (!retry) {
                            returnObj = response;
                            break;
                        }
...
AuthHttpRequest.attemptRefreshingSession = () =>
    __awaiter(this, void 0, void 0, function*() {
        ...
        return yield handleUnauthorised(preRequestIdToken);
    });
...
function onUnauthorisedResponse(preRequestIdToken, httpCall) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            ...
            const response = yield makeRequest(preAPIResult.url, preAPIResult.requestInit);
