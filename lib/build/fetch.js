...
AuthHttpRequest.doRequest = (httpCall, config, url) =>
    __awaiter(void 0, void 0, void 0, function*() {
        ...
        try {
            ...
            const postRequestIdToken = yield IdRefreshToken.getIdRefreshToken(false);
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            ...
            if (preRequestIdToken.status === "EXISTS") {
                const antiCsrfToken = yield AntiCSRF.getToken(preRequestIdToken.token);
                if (antiCsrfToken !== undefined) {
                    headers = Object.assign(Object.assign({}, headers), { "anti-csrf": antiCsrfToken });
                }
            }
            headers = Object.assign(Object.assign({ rid: AuthHttpRequest.rid }, headers), {
