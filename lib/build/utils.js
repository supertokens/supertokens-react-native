...
function storeInStorage(name, value, expiry) {
...
export function setAuthorizationHeaderIfRequired(clonedHeaders, addRefreshToken = false) {
    return __awaiter(this, void 0, void 0, function*() {
...
export function saveTokensFromHeaders(response) {
    return __awaiter(this, void 0, void 0, function*() {
